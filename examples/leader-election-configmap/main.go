...
func main() {
	...
	flag.StringVar(&cmLockName, "config-map-lock-name", "example", "the configmap lock resource name")
	...
	_, err = client.CoreV1().ConfigMaps(cmLockNamespace).Get(cmLockName, metav1.GetOptions{})
